...
public class InsertSourceGeneratorTest {
    ...
    public void simpleInsert() {
        ...
        String expected = "INSERT INTO t_user(`id`,`org_code`,`org_name`,`name`,`age`,`job`,`valid`,`create_time`,`create_id`,`create_name`,`update_time`,`update_id`,`update_name`)" +
                " VALUES (#{id},#{orgCode},#{orgName},#{name},#{age},#{job},#{valid},#{createTime},#{createId},#{createName},#{updateTime},#{updateId},#{updateName})";
