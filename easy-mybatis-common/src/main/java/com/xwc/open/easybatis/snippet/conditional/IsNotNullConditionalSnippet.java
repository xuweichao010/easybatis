 ...
 * 时间 2023/1/17 13:51
 */
public class IsNotNullConditionalSnippet implements SingleConditionalSnippet {

    private BatisPlaceholder placeholder;

    private ColumnPlaceholder columnPlaceholder;

    public IsNotNullConditionalSnippet(BatisPlaceholder placeholder, ColumnPlaceholder columnPlaceholder) {
    ...
    public String snippet(BatisColumnAttribute columnAttribute) {
        ...
        String conditionSql = "AND " + columnPlaceholder.holder(columnAttribute.useColumn(equal)) + " IS NOT NULL ";
