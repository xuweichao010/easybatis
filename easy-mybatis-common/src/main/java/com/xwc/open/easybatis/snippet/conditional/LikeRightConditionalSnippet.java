 ...
 * 时间 2023/1/17 13:51
 */
public class LikeRightConditionalSnippet implements SingleConditionalSnippet {

    private BatisPlaceholder placeholder;

    private ColumnPlaceholder columnPlaceholder;

    public LikeRightConditionalSnippet(BatisPlaceholder placeholder, ColumnPlaceholder columnPlaceholder) {
