 ...
 * 时间 2023/1/17 13:51
 */
public class NotEqualsConditionalSnippet implements SingleConditionalSnippet {

    private BatisPlaceholder placeholder;

    private ColumnPlaceholder columnPlaceholder;

    public NotEqualsConditionalSnippet(BatisPlaceholder placeholder, ColumnPlaceholder columnPlaceholder) {
    ...
    public String snippet(BatisColumnAttribute columnAttribute) {
        ...
        String conditionSql = "AND " + columnPlaceholder.holder(columnAttribute.useColumn(equal))
                + " != " + placeholder.holder(columnAttribute);
