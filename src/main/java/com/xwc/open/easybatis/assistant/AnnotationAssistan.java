...
import com.xwc.open.easybatis.excp.EasyBatisException;
...
import com.xwc.open.easybatis.support.table.AuditorColumn;
import com.xwc.open.easybatis.support.table.LoglicColumn;
import com.xwc.open.easybatis.support.table.PrimayKey;
...
public class AnnotationAssistan {
    ...
    public TableMeta parseEntityMate(Class<?> entityType) {
        ...
        for (Field field : fieldArr) {
            ...
            com.xwc.open.easybatis.support.table.Column column = analysisColunm(field, annotation, entityType);
            if (column != null) {
...
//            }
    ...
    public PrimayKey primayKey(Field field, Class<?> clazz) {
        ...
        com.xwc.open.easybatis.support.table.Column column = analysisColunm(field, id, clazz);
    ...
    public LoglicColumn loglic(Field field, Class<?> clazz) {
        ...
        com.xwc.open.easybatis.support.table.Column column = analysisColunm(field, loglic, clazz);
        if (column == null) return null;
    ...
    public AuditorColumn auditor(Annotation annotation, Field field, Class<?> clazz) {
        ...
        com.xwc.open.easybatis.support.table.Column column = analysisColunm(field, annotation, clazz);
        if (column == null) return null;
     ...
     */
    private com.xwc.open.easybatis.support.table.Column analysisColunm(Field field, Annotation annotation, Class<?> clazz) {
        Method getter;
        Method setter;
        try {
        ...
        com.xwc.open.easybatis.support.table.Column column = new com.xwc.open.easybatis.support.table.Column(map, getter, setter, field.getName());
