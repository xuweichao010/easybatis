...
public abstract class ParameterAttribute {
    ...
    public abstract List<ParameterAttribute> insert();

    public abstract List<ParameterAttribute> update();

    public abstract List<ParameterAttribute> select();

    public abstract List<ParameterAttribute> delete();
