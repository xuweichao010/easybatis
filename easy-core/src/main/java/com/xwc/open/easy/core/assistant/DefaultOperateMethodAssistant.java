...
import com.xwc.open.easy.core.annotations.Ignore;
import com.xwc.open.easy.core.annotations.Syntax;
...
import com.xwc.open.easy.core.model.parameter.*;
import com.xwc.open.easy.core.utils.AnnotationUtils;
import com.xwc.open.easy.core.utils.ParamNameUtil;
...
public class DefaultOperateMethodAssistant implements OperateMethodAssistant {
    ...
    @Override
    public OperateMethodMeta getMethodMeta(Class<?> clazz, Method method) {
        OperateMethodMeta methodMeta = getMethodMeta(method);
        methodMeta.setDatabaseMeta(configuration.getBaseModelAssistant().getDatabaseMeta(clazz));
        resolverMethodParams(method, methodMeta);
        return methodMeta;
    }

    private void resolverMethodParams(Method method, OperateMethodMeta methodMeta) {
