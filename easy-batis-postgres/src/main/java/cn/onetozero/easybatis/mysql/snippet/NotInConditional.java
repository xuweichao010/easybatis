...
public class NotInConditional implements SingleConditionalSnippet {
    ...
    public NotInConditional(AbstractBatisSourceGenerator sourceGenerator) {
    ...
    public String snippet(BatisColumnAttribute columnAttribute) {
        ...
        String conditionSql =
                "AND " + sqlPlaceholder.holder(columnAttribute.useColumn(In)) + " NOT IN " + MyBatisSnippetUtils.foreachItem("item", path);
